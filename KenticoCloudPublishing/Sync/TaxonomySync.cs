    ...
    internal partial class TaxonomySync : SyncBase
    {
        ...
        public async Task SyncCategories(CancellationToken? cancellation = null)
        {
            try
            {
                ...
                SyncLog.LogEvent(EventType.INFORMATION, "KenticoCloudPublishing", "UPSERTCATEGORIESTAXONOMY");
            ...
            {
                SyncLog.LogException("KenticoCloudPublishing", "UPSERTCATEGORIESTAXONOMY", ex);
                throw;
            }
        }
        ...
        private async Task DeleteCategoriesTaxonomy()
        {
            ...
            {
                SyncLog.LogException("KenticoCloudPublishing", "DELETECATEGORIESTAXONOMY", ex);
                throw;
            }
        }
        ...
        private async Task CreateCategoriesTaxonomy()
        {
            try
            {
                SyncLog.LogEvent(EventType.INFORMATION, "KenticoCloudPublishing", "CREATECATEGORIESTAXONOMY");
        ...
        public async Task DeleteAllTaxonomies(CancellationToken? cancellation)
        {
            try
            {
                ...
                SyncLog.LogEvent(EventType.INFORMATION, "KenticoCloudPublishing", "DELETEALLTAXONOMIES");
            ...
            {
                SyncLog.LogException("KenticoCloudPublishing", "DELETEALLTAXONOMIES", ex);
                throw;
            }
        }
