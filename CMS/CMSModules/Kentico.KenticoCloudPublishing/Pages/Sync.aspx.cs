...
using Kentico.KenticoCloudPublishing;

[UIElement("Kentico.KenticoCloudPublishing", "KenticoCloudPublishing")]
public partial class CMSModules_Kentico_KenticoCloudPublishing_Pages_Sync : GlobalAdminPage
{
    ...
    private KenticoCloudPublishingModule GetModule()
    {
        return ModuleManager.GetModule(KenticoCloudPublishingModule.MODULE_NAME) as KenticoCloudPublishingModule;
    }
